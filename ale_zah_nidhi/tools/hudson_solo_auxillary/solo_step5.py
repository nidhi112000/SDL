...
def generate_hso_file(
    ...
    Description: 
        Generates SOLOSoft .hso file for step 5 of the substrates workflow
    ...
    try: 
        ...
        substrates_start_column_5 = payload['substrates_start_column_5']
    ...
    for i in range(1, 13):  
        soloSoft.aspirate(
            ...
            aspirate_volumes=DeepBlock_96VWR_75870_792_sterile().setColumn(
                substrates_start_column_5, substrates_transfer_volume
            ),
