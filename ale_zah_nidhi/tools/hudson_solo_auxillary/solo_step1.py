...
# from liquidhandling import Reservoir_12col_Agilent_201256_100_BATSgroup, Plate_96_Corning_3635_ClearUVAssay, DeepBlock_96VWR_75870_792_sterile
# ask Casey for resoviour type DeepBlock_96VWR_75870_792_sterile
...
def generate_hso_file(
    ...
    try: 
        ...
        slot4_column = payload['slot4_column']
        slot6_column = payload['slot6_column']
...
# * Other program variables
    ...
    # Step 1 variables
    substrate_transfer_volume_s1 = 150
    ...
    for i in range(2):  # from second meDeepBlock.96.VWR-75870-792.steriledia column -> cell dilution plate
        soloSoft.aspirate(
            position="Position1",
            aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
    ...
    for i in range(1, 7):  # trying a different method of cell dispensing (09/07/21)
        soloSoft.aspirate(  # well in first half
            ...
            aspirate_shift=[payload["hso_2"] = hso_2
