...
def main():
    ...
    wf_path_1 = Path(
        "/home/rpl/workspace/BIO_workcell/applications/applications/applications/ale_zah_nidhi/workflows/create_substrate_plate_step1.yaml"
    )
    ...
    payload = {
        ...
        "substrates_start_column_1": 1,  # int of column to draw media from (requires 2 columns, 1 means columns 1 and 2) Ex. 1, 3, 5, et   
