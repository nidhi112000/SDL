...
def main():
    ...
    hidex_open = Path(
        "/home/rpl/workspace/BIO_workcell/growth_app/workflows/growth_curve/hidex_open.yaml"
    )
    hidex_run = Path(
        "/home/rpl/workspace/BIO_workcell/growth_app/workflows/growth_curve/hidex_run.yaml"
    )
    hidex_close = Path(
        "/home/rpl/workspace/BIO_workcell/growth_app/workflows/growth_curve/hidex_close.yaml"
    )
    peeler_peel = Path(
        "/home/rpl/workspace/BIO_workcell/growth_app/workflows/growth_curve/peeler_peel.yaml"
    )
